...
cdef class VideoFrame(Frame):
    ...
    cpdef VideoReformatter reformatter
    ...
    cdef _reformat(self, unsigned int width, unsigned int height, lib.AVPixelFormat format, int src_colorspace, int dst_colorspace, int resize_method)
